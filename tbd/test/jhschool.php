...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        echo '<script>
                    ...
                    document.getElementById("ajhschool").classList.add("active");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Junior High School</h1>
                    </div>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
                            <h6 class="m-0 font-weight-bold text-primary">Junior High School Table</h6>
                        </div>
